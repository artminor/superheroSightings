...
import sg.wat4method.superherospringmvc.dao.UserDao;
...
public class UserController {
    ...
    @Inject
    public UserController(UserDao dao, org.springframework.security.crypto.password.PasswordEncoder encoder) {
        this.dao = dao;
    ...
    public String addUser(HttpServletRequest req) {
        ...
        if (null != req.getParameter("isAdmin")) {
            newUser.addAuthority("ROLE_ORGADMIN");
        }
