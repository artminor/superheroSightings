<%-- 
    ...
    Created on : Jan 3, 2019, 1:10:55 PM
    Author     : Jun
--%>
...
<html>
    <head>
        ...
        <style>
            body {
                background-image: url("${pageContext.request.contextPath}/img/c3.jpg");
            }
        </style>
    </head>
    <body>
