<%-- 
    ...
    Created on : Jan 1, 2019, 3:35:05 PM
    Author     : Jun
--%>
...
<html>
    <head>
        ...
        <style>
            body {
                background-image: url("${pageContext.request.contextPath}/img/c4.jpg");
            }
        </style>
    </head>
    <body>
        <div class="container">
            ...
            <p>
                Location ID: <c:out value="${organization.locationId} "/>
            </p>
            <p>
                Location:  <a href="displayLocationDetails?locationId=${location.locationId}">
                    <c:out value="${location.name} "/></a>
            </p>
            <p>
            ...
            <table class="col-md-4 table table-hover" >
                <tr>
                    <th width="25%">Members in Organization: </th>
                </tr>

                <c:forEach items="${superList}" var="hero">
                    <tr>
                        <td>
                            <p><a href="displaySuperDetails?superId=${hero.superId}">
                                    <c:out value="${hero.name}"/></a></p>
                        </td>
                    </tr>
                </c:forEach>
            </table>
